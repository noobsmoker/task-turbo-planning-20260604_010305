...
High-performance task management and productivity tool - planning edition.
...
```bash
# Using HTTPS
git clone https://github.com/noobsmoker/task-turbo-planning-20260604_010305.git

# Or using SSH (if you have SSH keys configured)
git clone git@github.com:noobsmoker/task-turbo-planning-20260604_010305.git

# Navigate to the project directory
cd task-turbo-planning-20260604_010305
```
...
export PATH="$PATH:/home/sin_of_knowledge/projects/task-turbo-planning-20260604_010305"
...
$env:PATH += ";/home/sin_of_knowledge/projects/task-turbo-planning-20260604_010305"
...
```
task-turbo-planning-20260604_010305/
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/task-turbo-planning-20260604_010305.git
cd task-turbo-planning-20260604_010305
